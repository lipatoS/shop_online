...
public final class Constants {
    ...
    // DB
    public final static String DB_DRIVER = "jdbc:mysql://db4free.net:3306/";
    public final static String DB_NAME = "shop_online_2";

    public final static String PATH_MYSQL_CREDS = "mysql_creds/";
    public final static String DB_USER = "dev_adm";
